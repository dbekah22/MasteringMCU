...
int main(void)
{
	...
	while(1)
	{
		...
		I2C_MasterSendData(&I2C1Handle, &commandCode, 1, SLAVE_ADDR, I2C_EN_SR);	// Send code to get Len info from slave
		I2C_MasterReceiveData(&I2C1Handle, &Len, 1, SLAVE_ADDR, I2C_EN_SR);			// Receive Len info

		commandCode = 0x52;
		I2C_MasterSendData(&I2C1Handle, &commandCode, 1, SLAVE_ADDR, I2C_EN_SR);	// Send code to proceed with data RX
		I2C_MasterReceiveData(&I2C1Handle, rcv_buf, Len, SLAVE_ADDR, I2C_DI_SR);	// Receive data of length Len
